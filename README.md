...
Veterinary clinic is a database using PostgreSQL to show the  CRUD of data related to animals in a veterinary context. It provides a basic yet instructive example of data handling for educational purposes.
...
Just visit the [issues page](https://github.com/hydaline-code/vet-clinic_dbsql/issues) to chip in your contribution.
